    ...
    <div className="max-w-2xl mx-auto p-8 border border-gray-200 rounded-xl shadow-sm bg-white mt-8">
      ...
      <div className="border-b-2 border-gray-100 pb-4 mb-6">
        ...
        <input
          ...
          value={title}
          readOnly
          className="text-2xl font-extrabold text-gray-900 w-full outline-none bg-gray-50 p-2 rounded border-2 border-transparent"
        />
      </div>
      ...
      <div className="flex flex-col gap-4 mb-6">
        <div>
          ...
          <input
            ...
            value={author}
            readOnly
            className="w-full outline-none border-2 border-gray-100 bg-gray-50 p-3 rounded-lg text-gray-700"
          />
        </div>
        <div>
          <label className="text-xs font-semibold text-gray-500 mb-1 block">
